...
metadata:
  ...
  openclaw:
    ...
    requires:
      bins:
        - kobana
    cliHelp: "kobana banking financial --help"
---
...
```bash
kobana banking financial <resource> <method> [flags]
```
...
```bash
kobana banking financial --help
kobana banking financial accounts --help
